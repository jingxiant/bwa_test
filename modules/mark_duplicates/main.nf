process MARK_DUPLICATES{
        ...
        script:
        """
        gatk MarkDuplicates -I $bamfile -O ${bamfile.simpleName}.${params.timestamp}.sorted.rmdup.bam --CREATE_INDEX true --METRICS_FILE ${bamfile.simpleName}.${params.timestamp}
